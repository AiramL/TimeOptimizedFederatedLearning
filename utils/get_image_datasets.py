...
def split_data(dataset_name,DATASET_PATH="../datasets/"):
    ...
    # Save the files
    mkdir(DATASET_PATH+dataset_name)
    
    for index in np.unique(y_train):
        pickle.dump(dictClassTrain['class'+str(index)+'Train'],open(DATASET_PATH+dataset_name+'/class'+str(index)+'Train',"wb"))
    
    for index in np.unique(y_test):
        pickle.dump(dictClassTest['class'+str(index)+'Test'],open(DATASET_PATH+dataset_name+'/class'+str(index)+'Test',"wb"))

    for index in np.unique(y_test):
        pickle.dump(dictLabelTest['class'+str(index)+'TestLabel'],open(DATASET_PATH+dataset_name+'/class'+str(index)+'TestLabel',"wb"))

    for index in np.unique(y_train):
        pickle.dump(dictLabelTrain['class'+str(index)+'TrainLabel'],open(DATASET_PATH+dataset_name+'/class'+str(index)+'TrainLabel',"wb"))
