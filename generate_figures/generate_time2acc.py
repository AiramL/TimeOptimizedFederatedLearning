...
def process_accuracy_delays(n_clients=95,                                                                               dataset="WiSec",                                                                            acc_path="results/classification/processed/",                                               time_path="results/client_selection/processed/",                                            n_executions=10,                                                                            model_size=500,                                                                             language="pt"):
    ...
    plt.savefig("figures/"+dataset+"_time2acc_n_clients_"+str(n_clients)+language+".png",dpi=300,bbox_inches='tight')
